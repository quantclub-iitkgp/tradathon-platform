  ...
  return (
    <div className="relative">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <Image src="/globe.svg" width={800} height={800} alt="globe" className="opacity-20 mx-auto mt-[-80px] animate-pulse" />
      </div>
      <section className="max-w-5xl mx-auto px-4 py-20 text-center">
        ...
        <h1 className="mt-4 text-4xl md:text-6xl font-bold tracking-tight animate-in fade-in-50 zoom-in-50 duration-700 delay-75">Tradathon</h1>
        <p className="mt-3 text-muted-foreground mx-auto max-w-2xl animate-in fade-in-50 slide-in-from-bottom-2 duration-700 delay-100">
          Trade in a simulated market, solve puzzles to gain an edge, and climb the leaderboard.
        </p>
